      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-white">New Proforma</h1>
          </div>
          <p className="text-xs text-slate-500 mt-0.5">
            {hasLead
              ? `Pre-filled from lead · ${prefill.company_name || prefill.contact_person || "Lead"}`
              : "Fill in the details below — proforma number will be auto-generated"}
          </p>
        </div>
      </div>

      {/* Form */}
      <ProformaForm mode="create" prefill={prefill} />
    </div>
  );
}
