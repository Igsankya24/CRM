...
import { History, Download, FileSpreadsheet, FileText } from 'lucide-react';
...
export default function ContactsPage() {
  ...
  const exportHeaders = [
    "SR NO", "CUSTOMER NAME", "PHONE", "EMAIL", "COMPANY NAME", "ADDRESS", "CITY", "STATE", "PIN CODE", "COUNTRY"
  ];
  const exportColWidths = [
    "6%", "15%", "12%", "15%", "15%", "15%", "10%", "10%", "6%", "6%"
  ];
  ...
  const handleExportCSV = async () => {
    ...
    await exportToCSV({
      ...
      data: rows,
      filtersUsed: { search },
      filenamePrefix: "customer_master",
    });
  };
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {canTemplates && (
            <Button
              ...
              className="border-slate-700 text-slate-355 hover:bg-slate-800"
      ...
      <ImportWizard
        ...
        module="customer"
        onImportCompleted={fetchContacts}
      />
